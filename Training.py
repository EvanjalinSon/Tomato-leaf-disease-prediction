...
training_set = train_datagen.flow_from_directory('C:\\Users\\ELCOT\\Desktop\\Tomato-leaf-disease-classification\\Dataset\\train', # relative path from working directoy
                                                 target_size = (128, 128),
                                                 batch_size = 6, class_mode = 'categorical')
valid_set = test_datagen.flow_from_directory('C:\\Users\\ELCOT\\Desktop\\Tomato-leaf-disease-classification\\Dataset\\val', # relative path from working directoy
                                             target_size = (128, 128), 

...
filepath = 'C:\\Users\\ELCOT\\Desktop\\Tomato-leaf-disease-classification\\model.h5'
model = load_model(filepath)
print(model)

print("Model Loaded Successfully")

tomato_plant = cv2.imread('C:\\Users\\ELCOT\\Desktop\\Tomato-leaf-disease-classification\\Dataset\\Dataset\\test\\Tomato___Bacterial_spot (1).JPG')
